...
PLOT_DIR = BASE_DIR / "artifacts" / "plots" / "segmentation"
CLUSTER_DIR = BASE_DIR / "artifacts" / "segmentation"
PLOT_DIR.mkdir(parents=True, exist_ok=True)
CLUSTER_DIR.mkdir(parents=True, exist_ok=True)

MATRIX_PATH = FEATURE_DIR / "catalog_feature_matrix.npz"
METADATA_PATH = FEATURE_DIR / "catalog_feature_metadata.csv"
VALIDATION_PATH = CLUSTER_DIR / "kmeans_validation.csv"
...
def main() -> None:
    ...
    metadata.to_csv(CLUSTER_LABELS_PATH, index=False)
    ...
    summary = {
        ...
        "cluster_labels_path": str(CLUSTER_LABELS_PATH),
    }
