...
RATINGS = BASE_DIR / "data" / "processed" / "ratings_processed.csv"
...
for col in ["genres", "tags", "explicit_tags", "studios", "demographics", "synopsis", "type", "rating", "season"]:
...
# Week 5: representation scatter views.
numeric_cols = [
    "score",
    "scored_by",
    "rank",
...
ax.set_ylabel("PC2")
ax.grid(alpha=0.2)
save(WEEK5_DIR / "pca_2d_by_type.png")
...
ax.set_ylabel("SVD2")
ax.grid(alpha=0.2)
save(WEEK5_DIR / "svd_2d_by_members.png")
...
ax.grid(alpha=0.2)
save(WEEK5_DIR / "tsne_svd_catalog_sample.png")

# Week 7: cluster scatter and profile heatmap.
...
ax.set_ylabel("SVD2")
ax.grid(alpha=0.2)
save(WEEK7_DIR / "kmeans_svd_cluster_scatter.png")
...
save(WEEK7_DIR / "cluster_genre_profile_heatmap.png")
...
save(WEEK7_DIR / "optics_parameter_sweep.png")
...
for source in [
    ...
    WEEK5_DIR / "pca_mixed_catalog_explained_variance.png",
    WEEK5_DIR / "svd_sparse_catalog_energy.png",
    WEEK5_DIR / "pca_2d_by_type.png",
    WEEK5_DIR / "svd_2d_by_members.png",
    WEEK5_DIR / "tsne_svd_catalog_sample.png",
    WEEK7_DIR / "kmeans_parameter_sweep.png",
    WEEK7_DIR / "dbscan_parameter_sweep.png",
    WEEK7_DIR / "optics_parameter_sweep.png",
...
print("week7_best_k", best_k)
print("week7_best_k_silhouette", max(score for _, score in k_rows))
